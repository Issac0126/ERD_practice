...
(
	...
	content varchar2(2000) DEFAULT '' NOT NULL,
	-- 코멘트 작성자
...
(
	...
	reply_co varchar2(500) NOT NULL,
...
COMMENT ON COLUMN admins.id IS '코멘트 작성';
COMMENT ON COLUMN board.writer IS '코멘트 작성자';
COMMENT ON COLUMN members.id IS '코멘트 작성';
COMMENT ON COLUMN NEW_TABLE.stu_id IS '코멘트 작성';
COMMENT ON COLUMN reply.writer IS '코멘트 작성';
